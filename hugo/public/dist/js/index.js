...
},{"scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
new _scrollmagic.default.Scene({
  triggerElement: '#content > .hero-section',
  triggerHook: 0,
  offset: 50
}).setClassToggle('.navbar', 'scrolled').addIndicators().addTo(controller);
